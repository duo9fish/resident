...
COMMENT ON TABLE "public"."announcements" IS 'Announcements Details';
...
COMMENT ON TABLE "public"."billings" IS 'This is a duplicate of feedbacks';

ALTER TABLE "public"."billings" ALTER COLUMN "billing_id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."billings_feedback_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE POLICY "Policy with security definer functions" ON "public"."feedbacks" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "billings" ON "public"."billings" TO "authenticated" USING (true) WITH CHECK (true);

ALTER TABLE "public"."feedbacks" ENABLE ROW LEVEL SECURITY;

CREATE POLICY "name" ON "public"."announcements" TO "authenticated" USING (true) WITH CHECK (true);
...
GRANT ALL ON SEQUENCE "public"."billings_feedback_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."billings_feedback_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."billings_feedback_id_seq" TO "service_role";
